...
Por ejemplo, la película con una `id` de 1, <strong>Toy Story</strong>, pertenece a los géneros <em>Animation, Children's y Comedy</em>, y por lo tanto las columnas <em>Animation, Children's y Comedy</em> tienen un valor de 1 para Toy Story.
...
Para este ejemplo usaremos el archivo <em>ratings.dat</em>, que tiene el formato `user_id::movie_id::rating::timestamp`

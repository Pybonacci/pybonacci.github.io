...
publish:
	lessc $(BASEDIR)/theme/templates/main.less > $(BASEDIR)/theme/templates/main.css
...
publish-to-github: publish
	ghp-import -n -m "[skip ci] publish-to-github from $(GIT_COMMIT_HASH)" -b blog-build $(OUTPUTDIR)
	git push $(GITHUB_PAGES_REMOTE) blog-build:$(GITHUB_PAGES_BRANCH)

publish-to-github-force: publish
	ghp-import -n -m "[skip ci] publish-to-github-force from $(GIT_COMMIT_HASH)" -b blog-build $(OUTPUTDIR)
